...
```bash
# 1. Clone this repo
git clone https://github.com/Visual-Hive/eventhive-tool-exhibitor-manager.git
cd eventhive-tool-exhibitor-manager
...
| `TOOL_TITLE` | `Exhibitor Manager` | Title shown inside the tool |
